        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Banner1_1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Banner1_2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Banner1_3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Banner2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Banner3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Banner4 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaseDiameter = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CaseThickness = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    StrapColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    WatchStyle = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MechanicalWatchId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    CalendarFunction = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    CaseShape = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MechanicalWatches", x => x.MechanicalWatchId);
                    table.ForeignKey(
                        name: "FK_MechanicalWatches_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SmartWatchId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    BateryLife = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SmartWatches", x => x.SmartWatchId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImportDetails_ImportBills_ImportBillId",
            ...
            migrationBuilder.InsertData(
                table: "Settings",
                columns: new[] { "SettingId", "Banner1_1", "Banner1_2", "Banner1_3", "Banner2", "Banner3", "Banner4", "ShippingFee" },
                values: new object[] { 1, "/images/banner/banner1_1.jpg", "/images/banner/banner1_2.png", "/images/banner/banner1_3.jpg", "/images/banner/banner2.jpg", "/images/banner/banner3.jpg", "/images/banner/banner4.jpg", 500000m });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ImportDetails_ImportBillId",
                table: "ImportDetails",
                column: "ImportBillId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MechanicalWatches_ProductId",
                table: "MechanicalWatches",
                column: "ProductId",
                unique: true);
